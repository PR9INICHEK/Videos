...
2. Показываю, как я выбираю сервер из под раздела с избранными сценариями
3. Показываю на реальном сервере
...
4. Сообщаю, что в следующих роликах покажу и расскажу всякие полезности
5. 
6. 


# Текст
Ваня или дорогой друг, Conflict - это же просто старый-добрый режим по захвату острова(Capture the Island - CTI), в который играют ещё с Operation Flashpoint или как ещё её называют Arma 0
